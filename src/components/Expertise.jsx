  ...
  return (
    <>
      <div className='px-5 py-16 bg-[#C0E3FC] overflow-x-hidden'>
        ...
        <h1 className='text-center font-semibold font-inter text-4xl text-black mb-14'>
            ...
            {services?.map((service, idx) => (
              <div className='relative mx-auto' key={idx}>
                ...
                <h1
                  ...
                  className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white text-2xl font-bold outline-2 outline-black '
                >
                  {service.title}
                </h1>
              </div>
